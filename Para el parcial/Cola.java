...
public class ClasePrincipal {
            ...
            switch (opcion) {
                ...
                case 4:
                    JOptionPane.showMessageDialog(null,
                            "La cantidad de elementos primos es: " + cola.CantidadNumerosPrimos());
                    break;

                case 5:
                    JOptionPane.showMessageDialog(null,
                            "La suma de los primeros elementos pares y los ultimos elementos impares es: "
                                    + cola.PrimerParUltimoImpar());
                    break;

                case 6:
                    JOptionPane.showMessageDialog(null,
                            "La suma del primer elemento y el elemento mas grande es: " + cola.SumaPrimeroYMasGrande());
                    break;
                case 7:
                    opcion = 7;
                    break;
    ...
    public static class Cola {
        ...
        public void MostrarUltimoDato() {
            if (!ColaVacia()) {
                JOptionPane.showMessageDialog(null, "El ultimo elemento de la cola es: "
                        + rear.info);
            } else {
                JOptionPane.showMessageDialog(null, "La cola esta vacía");
            }
        ...
        //metodo para sumar el primer numero primo y el ultimo par de la cola
        public int PrimerPrimoUltimoPar() {
            int primo = 0, par = 0;
            Nodo puntero = front;
            int bandera = 0;
            ...
            while (puntero != null) {
              if (bandera != 1) {
                if (puntero.EsPrimo(puntero.info)) {
                  primo = puntero.info;
                  bandera = 1;
                }
              }
